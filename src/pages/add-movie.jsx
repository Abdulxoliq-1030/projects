...
class AddMovie extends Component {
  ...
  validate = () => {
    ...
    const { errors } = {};
    if (genre.trim() === "") errors.genre = "Genre is Reuqired";
    if (title.trim() === "") errors.title = "Title is Reuqired";
    if (id.trim() === "") errors.id = "Id is Reuqired";
    if (rate.trim() === "") errors.rate = "Rate is Reuqired";
    if (stock.trim() === "") errors.stock = "Stock is Reuqired";
  };
